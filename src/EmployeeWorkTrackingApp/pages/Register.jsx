  ...
  return (
    <div className="min-h-screen overflow-y-auto overflow-x-hidden md:h-screen md:overflow-hidden flex flex-col md:flex-row w-full font-sans bg-gray-50">
      ...
      <motion.div
        ...
        className="w-full md:w-7/12 lg:w-1/2 flex flex-col justify-center items-center p-6 md:p-10 bg-white min-h-[65vh] md:h-screen md:overflow-y-auto custom-scrollbar order-2 relative"
      >
